...
class TestHuwiseDatasetCreation:
    ...
    def test_huwise_dataset_with_uid_creates_instance(
    ...
    def test_huwise_dataset_uid_format_accepted(
        self, mock_config: HuwiseConfig
    ) -> None:
...
class TestHuwiseDatasetGetters:
    ...
    def test_get_keywords_returns_list_from_metadata(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
    ...
    def test_get_language_returns_language_code(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
    ...
    def test_get_publisher_returns_publisher_name(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
    ...
    def test_get_metadata_returns_full_metadata_dict(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
    ...
    def test_get_title_returns_none_when_missing(
        self, mock_dataset: HuwiseDataset
    ) -> None:
...
class TestHuwiseDatasetSetters:
    ...
    def test_set_keywords_returns_self_for_chaining(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
...
class TestHuwiseDatasetPublishing:
    ...
    def test_publish_calls_correct_endpoint(
        ...
        mock_dataset._client.post.assert_called_once_with(
            "/datasets/da_tbcnel/publish/"
        )

    def test_unpublish_calls_correct_endpoint(
        self, mock_dataset: HuwiseDataset
    ) -> None:
        ...
        mock_dataset._client.post.assert_called_once_with(
            "/datasets/da_tbcnel/unpublish/"
        )

    def test_publish_returns_self_for_chaining(
        self, mock_dataset: HuwiseDataset
    ) -> None:
    ...
    def test_unpublish_returns_self_for_chaining(
        self, mock_dataset: HuwiseDataset
    ) -> None:
...
class TestHuwiseDatasetMethodChaining:
    ...
    def test_multiple_setters_can_be_chained(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
    ...
    def test_refresh_returns_self_for_chaining(
        self, mock_dataset: HuwiseDataset, sample_metadata: dict
    ) -> None:
...
class TestHuwiseDatasetStatusHandling:
    ...
    def test_wait_for_idle_polls_until_idle(
        self, mock_dataset: HuwiseDataset
    ) -> None:
